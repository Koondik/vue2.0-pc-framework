...
.el-button--danger {
    color: #fff!important;
    background-color: #f68a8a!important;
...
.table-wrap{
    ...
    thead tr{
        border-bottom:1px solid #b3cceb;
    }
    thead tr th{
...
.el-checkbox.card{
    ...
    background-color: #fff;
    overflow: hidden;
    box-shadow: 0 2px 4px rgba(0,0,0,.12),inset -2px 0 2px rgba(0, 0, 0, 0.12),inset 2px 0 2px rgba(0, 0, 0, 0.12);
    .el-checkbox__input{
        width:43px;
    }
    .el-checkbox__label{
